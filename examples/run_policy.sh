python -m lerobot.record \
    ...
    --policy.path=/home/jony/code/anttAI/lerobot/outputs/train/act_so101_test_new2/checkpoints/last/pretrained_model \
    --display_data=true \
    --dataset.push_to_hub=False \
    --dataset.repo_id=AnttAI/eval_record-test3_e1 \
